...
function addMessage(text, from = 'user') {
    ...
    if (from === 'bot') {
        img.src = (chatbotConfig && chatbotConfig.chatbot_avatar) ? chatbotConfig.chatbot_avatar : '/static/img/bot-avatar.png';
        img.alt = 'Bot';
    } else {
        img.src = (chatbotConfig && chatbotConfig.user_avatar) ? chatbotConfig.user_avatar : '/static/img/user-avatar.png';
        img.alt = 'You';
    }
...
const canned = {
    'menu': (cfg) => cfg && cfg.menu_text ? cfg.menu_text : 'Our menu includes pizzas, salads, burgers and daily specials.',
